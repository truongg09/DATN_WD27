      ...
      <aside className="admin-sidebar">
        ...
        <nav className="admin-nav">
          <ul>
            ...
            <li><Link to="/admin/booking-services">Dịch vụ phát sinh</Link></li>
            <li><Link to="/admin/room-items">Vật dụng phòng</Link></li>
            <li><Link to="/admin/damage-reports">Báo hỏng</Link></li>
